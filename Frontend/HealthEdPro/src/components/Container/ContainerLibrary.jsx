...
import libimg from "../../assets/libimg.png";
import { FaNewspaper,  FaShieldAlt,  FaBrain, FaSyncAlt, FaCheckCircle, FaArrowRight, FaLightbulb, FaClock, FaGraduationCap, FaHandsHelping } from "react-icons/fa";
...
const WhyUseHealthEdPro = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Comprehensive articles on various health topics, providing detailed and reliable information.",
details: "From anxiety and depression to less common conditions, our resources include symptoms, treatment options, and personal coping strategies developed by certified mental health professionals."
    },
    {
      title: "Regular Updates:",
      icon: <FaSyncAlt className="text-purple-500 text-xl" />,
      description: "Constantly updated with the latest health information and research to ensure users have access to the most current knowledge.",
      details: "Our team of medical professionals reviews and updates content weekly to incorporate new research findings and health guidelines."
    },
    {
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center p-3 md:p-4">
        ...
        <div className="mt-4 flex justify-center">
          ...
          >
            ...
            <Link to="/Library" className="absolute inset-0 z-20"></Link>
          </button>
        </div>
